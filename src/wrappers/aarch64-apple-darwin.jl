# Autogenerated wrapper script for aws_c_auth_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libaws_c_auth, "@rpath/libaws-c-auth.1.0.0.dylib")
function __init__()
    JLLWrappers.@generate_init_header(aws_c_cal_jll, aws_c_http_jll, aws_c_sdkutils_jll)
    JLLWrappers.@init_library_product(
        libaws_c_auth,
        "lib/libaws-c-auth.1.0.0.dylib",
